  ...
  tryCatch({
    ...
    if (length(number) > 1) {
      ...
      if (less_than_10_as_words == TRUE){
        ...
        if (as_number(number) == 1) {
          number <- "one"
        }
        else  if (as_number(number) == 2) {
          number <- "two"
        }
        else  if (as_number(number) == 3) {
          number <- "three"
        }
        else  if (as_number(number) == 4) {
          number <- "four"
        }
        else  if (as_number(number) == 5) {
          number <- "five"
        }
        else  if (as_number(number) == 6) {
          number <- "six"
        }
        else  if (as_number(number) == 7) {
          number <- "seven"
        }
        else  if (as_number(number) == 8) {
          number <- "eight"
        }
        else  if (as_number(number) == 9) {
          number <- "nine"
        }
        else number
