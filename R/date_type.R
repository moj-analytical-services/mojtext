#' Format dates
#'
#' Transform dates in %Y %m %d format (e.g. 2012-12-31) with arbitrary or no separators, to a specified date format.
#'
#' @param date A date in %Y %m %d format.
#' @param type Specifies the format that the date should be returned in, using standard R date types, e.g. '%Y'.
#'
